...
class NeuralNetwork(object):
    def __init__(self, input_nodes, hidden_nodes, output_nodes, learning_rate):
        ...
        # Initialize weights   #this is similar to Xavier initilization normalized by input node size std
    ...
    def forward_pass_train(self, X):
        ...
        final_outputs = final_inputs #np.clip(final_inputs,a_min=0,a_max=None) # signals from final output layer
    ...
    def backpropagation(self, final_outputs, hidden_outputs, X, y, delta_weights_i_h, delta_weights_h_o):
        ...
        #if(final_inputs>0): #RELU seem not needed here
        output_error_term = error*1.0   #derivative one
        #else:
        #    output_error_term = error*0.0
        
        # TODO: Calculate the hidden layer's contribution to the error
        hidden_error = np.dot(self.weights_hidden_to_output,output_error_term)
        #print(np.shape(hidden_error))
